<?php
/*
Plugin Name: Adios Demo Importer
Plugin URI: http://themebubble.com
Description: Loads Demo for Adios theme.
Version: 1.0
Author: relstudiosnx
...
if(!function_exists('redux_register_custom_extension_loader_demo')) :
    ...
    add_action("redux/extensions/adios_theme_options/before", 'redux_register_custom_extension_loader_demo', 0);
endif;
