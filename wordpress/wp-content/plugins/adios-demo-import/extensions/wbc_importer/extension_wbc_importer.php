            ...
            $this->parent->sections[] = array(
                ...
                'fields' => array(
                    array(
                          'id'       => 'demo-info',
                          'type'     => 'info',
                          'desc'     => '<h3 style="color:#555d66;"> Importing a demo will create pages, posts, add images, theme options, widgets and others. IMPORTANT: After importing demo content DON\'T forget to INSTALL regenerate the thumbnails plugin and regenerate thumbnails using <a href="'.admin_url('tools.php?page=regenerate-thumbnails').'">regenerate thumbnails plugin</a>.
                          </h3>',
                        ),
                                        array(
