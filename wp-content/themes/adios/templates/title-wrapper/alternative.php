...
<?php if(adios_get_opt('title-wrapper-enable') == 1 && !is_singular('portfolio')): ?>
<div class="top-baner smal-size">
 <div class="block-bg top-image <?php echo adios_get_opt('title-wrapper-full-width') ? 'full-wh':'no-full-wh'; ?>">
  <div class="bg-wrap">
